...
raw_student_calendar_events_sample = [
    {"id": "event1", "course_id": "CS101", "title": "Nhập môn Lập trình - Buổi 1", "date": today.strftime("%Y-%m-%d"), "start_time": "07:30", "end_time": "09:30", "lecturer_materials_url": "#"},
    {"id": "event2", "course_id": "MA101", "title": "Toán cao cấp A1 - Buổi 1", "date": (today + datetime.timedelta(days=1)).strftime("%Y-%m-%d"), "start_time": "09:45", "end_time": "11:45", "lecturer_materials_url": "#"},
    {"id": "event3", "course_id": "CS101", "title": "Nhập môn Lập trình - Buổi 2", "date": (today + datetime.timedelta(days=7)).strftime("%Y-%m-%d"), "start_time": "07:30", "end_time": "09:30", "lecturer_materials_url": "#"},
    {"id": "event4", "course_id": "CS101", "title": "Nhập môn Lập trình - Buổi 3 (Lab)", "date": (today + datetime.timedelta(days=9)).strftime("%Y-%m-%d"), "start_time": "13:30", "end_time": "15:30", "lecturer_materials_url": "#"},
    {"id": "event5", "course_id": "EN101", "title": "Tiếng Anh học thuật 1 - Buổi 1", "date": (today + datetime.timedelta(days=3)).strftime("%Y-%m-%d"), "start_time": "09:45", "end_time": "11:45", "lecturer_materials_url": "#"},
]
...
def format_date_display_filter(value):
    ...
    try:
        ...
        return value # Trả về giá trị gốc nếu không định dạng được (Return original value if formatting fails)
